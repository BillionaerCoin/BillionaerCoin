...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s billionaercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  billionaercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded billionaercoin transaction") + "\n" +
              "  billionaercoin-tx [options] -create [commands]   " + _("Create hex-encoded billionaercoin transaction") + "\n" +
              "\n";
