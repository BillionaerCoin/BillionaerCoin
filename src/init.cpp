...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BillionaerCoin/BillionaerCoin>";
    const std::string URL_WEBSITE = "<https://billionaercoin.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BillionaerCoin version %s\n", FormatFullVersion());
}
